...
Run with pytest.  (A hand-rolled --unit/--integration/--performance CLI
this docstring used to advertise is long gone, along with the _Stats
pass-counter scaffolding — a fresh instance per test whose summary nothing
ever read.)
"""

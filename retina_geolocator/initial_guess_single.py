...
if __name__ == "__main__":
    ...
    initial_guess = generate_initial_guess(test_track, tx_enu, geometry["antenna_boresight_vector"], config.frequency)
    ...
    predicted_delay = bistatic_delay(initial_guess[0:3], tx_enu, (0, 0, 0))
